...
import '/screens/login_screen.dart'; // Redirection après inscription
  ...
  Future<void> _register() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://127.0.0.1:5001/register'), // Remplacez par l'URL correcte
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true) {
          ...
          setState(() {
            _errorMessage = data['message'] ?? 'Invalid registration details';
          });
        }
      } else {
        setState(() {
